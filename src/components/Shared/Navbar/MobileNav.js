...
const MobileNav = ({ open, setToggle }) => {
  ...
  const linkStyle =
    "flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm text-gray-400 font-medium hover:text-[#fff]  hover:bg-gray-800/50";
    ...
    >
      ...
      >
        <div className="item-center  flex flex-col justify-start">
                ...
                >
                  ...
                  <defs>
                    <clipPath id="clip0_17_17">
                      <rect width="778" height="222" fill="white"></rect>
                    </clipPath>
                  </defs>
                </svg>
              </Link>
          ...
          <div className="mx-2">
            <div className=" my-4 border-b-[.5px] border-[#565656]" />
            <div>
              <button className=" flex w-full items-center justify-center rounded-md border border-transparent bg-white px-4 py-2 text-sm font-medium text-[#3a3a3a] shadow-sm focus:outline-none ">
                Login
              </button>
            </div>
          </div>
